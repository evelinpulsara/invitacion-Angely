...
export default function XVInvitation() {
  ...
  return (
    <div 
      ...
      style={{
        // Eliminamos el background de este div y lo movemos al siguiente
      }}
    >
      {/* 👇 Este es el nuevo contenedor que forzará el fondo a cubrir toda la pantalla */}
      <div 
        className="min-h-screen w-full"
        style={{
          backgroundImage: "url('/imagenes/Fondo.jpeg')",
          backgroundSize: 'cover', // 👈 Vuelve a usar 'cover'
          backgroundRepeat: 'no-repeat',
          backgroundPosition: 'center',
          backgroundAttachment: 'fixed', // Opcional: mantiene el fondo fijo al hacer scroll
        }}
      >
